...
import '../../widgets/tasks/task_timeline_widget.dart';
import '../../widgets/tasks/history_dialog.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: Icon(_isTimelineView ? Icons.list : Icons.view_timeline, color: Colors.white),
            tooltip: _isTimelineView ? 'Ver como lista' : 'Ver línea de tiempo',
            ...
            child: _isLoading 
              ...
              : _error != null
                ...
                : _filteredTasks.isEmpty
                  ...
                  : _isTimelineView
                    ? TaskTimelineWidget(tasks: _filteredTasks)
                    : RefreshIndicator(
